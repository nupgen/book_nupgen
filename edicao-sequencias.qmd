...
Os arquivos FASTA podem ser abertos no programa [MEGA](mega.qmd) (ou mesmo no bloco de notas para uma edição rápida no nome das sequências, por exemplo), enquanto os eletroferogramas podem ser visualizados com o programa [BioEdit](bioedit.qmd).
