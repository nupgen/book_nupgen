...
Definir o local que será realizada a coleta é fundamental, pois quanto melhor o local, menos esforço amostral será necessário e, consequentemente, menos dinheiro será gasto. Converse com outras pessoas que já realizaram coletas no mesmo ambiente previamente.
...
Qualquer viagem maior para uma coleta deve ser muito bem planejada, já que existem diversos riscos e problemas inerentes de uma coleta. Abaixo temos uma lista de coisas importantes a serem planejadas antes de uma coleta.

- Kit de primeiros socorros

- Localização de hospitais próximos com soro antiofídico

- Botinas e roupas fáceis para coleta

- Tubos, álcool e material para coleta de tecido
