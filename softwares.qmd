...
**Prós:** fácil visualização dos haplótipos em uma rede autoexplicativa.

**Contras:** poucas atualizações do software, o que dificulta encontrar a origem dos "bugs" quando é rodada a análise.
